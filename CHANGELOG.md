...
- Deterministic check names in reports now use human-friendly labels (e.g. "Keyword Coverage", "Near-Duplicate Products", "Product Title Length")
...
[Unreleased]: https://github.com/asarnaout/veritail/compare/v0.2.0...HEAD
