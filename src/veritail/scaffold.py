...
# ---------------------------------------------------------------------------
# Autocomplete / type-ahead evaluation
# ---------------------------------------------------------------------------
...
def scaffold_project(
    ...
    """Create starter adapter, query, and prefix files for a new project.

    Always generates a full adapter with both search() and suggest(),
    a queries CSV, and a prefixes CSV.
    """
    ...
    all_paths = [adapter_path, queries_path, prefixes_path]
    ...
    adapter_content = ADAPTER_TEMPLATE + SUGGEST_FUNCTION_TEMPLATE
